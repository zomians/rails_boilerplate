class SignaturesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @signature.update(signature_params)
        format.html { redirect_to @signature, notice: "Signature was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to signatures_path, notice: "Signature was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def signature_params
      params.expect(signature: [ :name, :address, :message ])
    end
end
